...
RSpec.describe HubsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested hub as @hub" do
      hub = Hub.create! valid_attributes
      get :show, params: {id: hub.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested hub as @hub" do
      hub = Hub.create! valid_attributes
      get :edit, params: {id: hub.to_param}, session: valid_session
      expect(assigns(:hub)).to eq(hub)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Hub" do
        expect {
          post :create, params: {hub: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved hub as @hub" do
        post :create, params: {hub: invalid_attributes}, session: valid_session
        expect(assigns(:hub)).to be_a_new(Hub)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested hub" do
        hub = Hub.create! valid_attributes
        put :update, params: {id: hub.to_param, hub: new_attributes}, session: valid_session
        hub.reload
      ...
      it "assigns the requested hub as @hub" do
        hub = Hub.create! valid_attributes
        put :update, params: {id: hub.to_param, hub: valid_attributes}, session: valid_session
        expect(assigns(:hub)).to eq(hub)
      end
    ...
    context "with invalid params" do
      it "assigns the hub as @hub" do
        hub = Hub.create! valid_attributes
        put :update, params: {id: hub.to_param, hub: invalid_attributes}, session: valid_session
        expect(assigns(:hub)).to eq(hub)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested hub" do
      hub = Hub.create! valid_attributes
      expect {
        delete :destroy, params: {id: hub.to_param}, session: valid_session
      }.to change(Hub, :count).by(-1)
    end
